...
-- Police Vehicles
Config.PoliceVehicles = {'polvic','polstang','polchal','polvette','polexp','polchar','polblazer','polbike','ucbanshee','ucrancher','ucbuffalo','ucballer'}

-- Ems Vehicles
Config.EmsVehicles = {'emsspeedo'}
